...
def pantalla_final(puntos_total, partidas, ganadas):
    ...
    if bbs_scores.entra_en_top_local(puntos_total, max_top=MAX_TOP, ascending=ASCENDING):
        ...
        bbs_scores.save_local(nombre, puntos_total, max_top=MAX_TOP, ascending=ASCENDING)
        bbs_scores.submit(nombre, puntos_total)
