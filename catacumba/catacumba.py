...
def pantalla_victoria(pasos, tiempo, kills, total):
    ...
    print(margen + c("╠" + linea + "╣", "verdeB"))
    print(margen + lado + f"  Pasos dados   : {c(str(pasos).rjust(20), 'amarB', 'bold')}".ljust(ancho + 15) + lado)
    print(margen + lado + f"  Tiempo (seg)  : {c(str(int(tiempo)).rjust(20), 'cyanB', 'bold')}".ljust(ancho + 15) + lado)
    print(margen + lado + f"  Ratas muertas : {c(f'{kills}/{total}'.rjust(20), 'magentaB', 'bold')}".ljust(ancho + 15) + lado)
    print(margen + c("╚" + linea + "╝", "verdeB"))
    print()
    try:
