...
def pantalla_final(dist, overtakes, crashes, score, top_entered, scores, nombre_guardado=None):
    ...
    print(margen + c("╠" + linea + "╣", "magentaB"))
    print(margen + lado + f"  Distancia       : {c(str(int(dist)).rjust(15) + ' m', 'cyanB', 'bold')}".ljust(ancho + 12) + lado)
    print(margen + lado + f"  Adelantamientos : {c(str(overtakes).rjust(15) + '  ', 'verdeB', 'bold')}".ljust(ancho + 12) + lado)
    print(margen + lado + f"  Choques         : {c(str(crashes).rjust(15) + '  ', 'rojoB', 'bold')}".ljust(ancho + 12) + lado)
    print(margen + lado + f"  PUNTUACION      : {c(str(score).rjust(15) + '  ', 'amarB', 'bold')}".ljust(ancho + 12) + lado)
    if top_entered:
